$(function(){
    ...
    'ライコウ', 'エンテイ', 'スイクン', 'ホウオウ', 'ラティオス', 'ズガイドス', 'ラムパルド', 'レシラム', 'ソルガレオ', 'ルギア', 'ラティアス', 'タテトプス', 'トリデプス', 'コバルオン', 'テラキオン', 'ビリジオン', 
    'ゼクロム', 'ルナアーラ', 'フシギダネ', 'フシギソウ', 'フシギバナ', 'ヒトカゲ', 'リザード', 'リザードン', 'ゼニガメ', 'カメール', 'カメックス', 'ナゾノクサ', 'クサイハナ', 'ラフレシア', 'メノクラゲ', 'ドククラゲ', 
    'ドードー', 'ドードリオ', 'タマタマ', 'ナッシー', 'ナッシー(アローラ)', 'サイホーン', 'サイドン', 'パウワウ', 'ジュゴン', 'サワムラー', 'エビワラー', 'タッツー', 'シードラ', 'エレブー', 'ブーバー', 'ラプラス', 
    'ポリゴン', 'チコリータ', 'ベイリーフ', 'メガニウム', 'ヒノアラシ', 'マグマラシ', 'バクフーン', 'ワニノコ', 'アリゲイツ', 'オーダイル', 'チョンチー', 'ランターン', 'キレイハナ', 'ブルー', 'グランブル', 'バルキー', 
    'カポエラー', 'エアームド', 'キングドラ', 'ポリゴン２', 'ドーブル', 'エレキッド', 'ブビィ', 'キモリ', 'ジュプトル', 'ジュカイン', 'アチャモ', 'ワカシャモ', 'バシャーモ', 'ミズゴロウ', 'ヌマクロー', 'ラグラージ', 
    'プラスル', 'マイナン', 'ナックラー', 'ビブラーバ', 'フライゴン', 'ダンバル', 'メタング', 'メタグロス', 'ドサイドン', 'エレキブル', 'ブーバーン', 'ポリゴンＺ', 'ツタージャ', 'ジャノビー', 'ジャローダ', 'ポカブ', 
    'チャオブー', 'エンブオー', 'ミジュマル', 'フタチマル', 'ダイケンキ', 'シママ', 'ゼブライカ', 'モグリュー', 'ドリュウズ', 'モンメン', 'エルフーン', 'ズルッグ', 'ズルズキン', 'チラーミィ', 'チラチーノ', 'ユニラン', 
    'ダブラン', 'ランクルス', 'バチュル', 'デンチュラ', 'ゴビット', 'ゴルーグ', 'キュレム', 'キュレム(ホワイト)', 'キュレム(ブラック)', 'ハリマロン', 'ハリボーグ', 'ブリガロン', 'ケロマツ', 'ゲコガシラ', 'ゲッコウガ', 
    'ニャスパー', 'ニャオニクス', 'マーイーカ', 'カラマネロ', 'モクロー', 'フクスロー', 'ジュナイパー', 'ニャビー', 'ニャヒート', 'ガオガエン', 'アシマリ', 'オシャマリ', 'アシレーヌ', 'ツツケラ', 'ケララッパ', 
    'ドデカバシ', 'シズクモ', 'オニシズクモ', 'キュワワー', 'メテノ', 'メテノ(コア)', 'ネクロズマ', 'ネクロズマ(たそがれ)', 'ネクロズマ(あかつき)', 'マホミル', 'マホイップ', 'ジュラルドン', 'ブリジュラス', 
    'カミツオロチ', 'テラパゴス(ノーマル)', 'テラパゴス(テラスタル)', 'テラパゴス(ステラ)', 'タケルライコ', 'テツノカシラ', 'ウガツホムラ', 'テツノイワオ', 'ヒバニー', 'ラビフット', 'エースバーン', 'メッソン', 
    'ジメレオン', 'インテレオン', 'ウネルミナモ', 'テツノイサハ'];
